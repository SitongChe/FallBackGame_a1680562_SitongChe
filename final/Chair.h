...
private:
	...
	GLUquadric * quadric;
public:
	Chair(float _x, float _y, float _z, float _width, float _height, float _depth, BoundingBox * _box, Material * _mat, unsigned int _textureID, float _texWidth, float _texHeight);
	~Chair();
