 ...
 */
//third step - add the option to parallax map 
//this means implementing the appropriate shader calculations
//for the latter, of course, we could use the same shader and pass uniforms 
//that switches on or off bump map calculations
//or we could load a differnt shader
//we choose passing the uniforms....
//also means adding load of height texture
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <vector>
...
void Cube::free_resources()
{
  glDeleteProgram(program);
  glDeleteTextures(1, &normalmap_id);
  glDeleteTextures(1, &heightmap_id);
}
...
//    if (use_bump) {use_bump=GL_FALSE;
//                  std::cerr << "no bump mapping " <<std::endl;
//                  }
//      else    {
//                 use_bump=GL_TRUE;
//                  std::cerr << "using bump mapping " <<std::endl;
//               }
//   //update Uniform.... either here or in display - put in display
//   glutPostRedisplay();
//   break;
//    case 'p': //toggle parallax
//    if (use_parallax) {use_parallax=GL_FALSE;
//                  std::cerr << "no parallax mapping " <<std::endl;
//                  }
//      else    {
//                 use_parallax=GL_TRUE;
//                  std::cerr << "using parallax mapping " <<std::endl;
//               }
//   //update Uniform.... either here or in display - put in display
//   glutPostRedisplay();
//  }
